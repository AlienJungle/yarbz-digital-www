...
export default function TermsOfService() {
  return (
    <motion.main
      className="container mx-auto relative prose mb-20"
...
<p>We operate the website https://www.yarbz.digital (the '<strong>Site</strong>'), as well as any other related products and services that refer or link to these legal terms (the '<strong>Legal Terms</strong>') (collectively, the '<strong>Services</strong>').</p>
<p>You can contact us by phone at 07861683881, email at aaron@yarbz.digital, or by mail to PO Box C/O NATA, ARCH WORKSPACE LINTONVILLE PARKWAY, ASHINGTON, NORTHUMBERLAND NE63 9JZ,&nbsp;England.</p>
<p>These Legal Terms constitute a legally binding agreement made between you, whether personally or on behalf of an entity ('<strong>y</strong><strong>ou</strong>'), and Alien Jungle Ltd, concerning your access to and use of the Services. You agree that by accessing the Services, you have read, understood, and agreed to be bound by all of these Legal Terms. IF YOU DO NOT AGREE WITH ALL OF THESE LEGAL TERMS, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SERVICES AND YOU MUST DISCONTINUE USE IMMEDIATELY.</p>
<p>We will provide you with prior notice of any scheduled changes to the Services you are using. The modified Legal Terms will become effective upon posting or notifying you by aaron@yarbz.digital, as stated in the email message. By continuing to use the Services after the effective date of any changes, you agree to be bound by the modified terms.</p>
...
<p>If you wish to make any use of the Services, Content, or Marks other than as set out in this section or elsewhere in our Legal Terms, please address your request to: aaron@yarbz.digital. If we ever grant you the permission to post, reproduce, or publicly display any part of our Services or Content, you must identify us as the owners or licensors of the Services, Content, or Marks and ensure that any copyright or proprietary notice appears or is visible on posting, reproducing, or displaying our Content.</p>
...
<p>You agree to provide current, complete, and accurate purchase and account information for all purchases made via the Services. You further agree to promptly update account and payment information, including email address, payment method, and payment card expiration date, so that we can complete your transactions and contact you as needed. Sales tax will be added to the price of purchases as deemed required by us. We may change prices at any time. All payments shall be&nbsp;in Great British Pound.</p>
...
<ol>
<li><strong>CONTRIBUTION LICENCE</strong></li>
</ol>
...
<ol>
<li><strong>THIRD-PARTY WEBSITES AND CONTENT</strong></li>
</ol>
...
<p>These Legal Terms are governed by and interpreted following the laws of England and Wales, and the use of the United Nations Convention of Contracts for the International Sales of Goods is expressly excluded. If your habitual residence is in the EU, and you are a consumer, you additionally possess the protection provided to you by obligatory provisions of the law in your country to residence. Alien Jungle Ltd and yourself both agree to submit to the non-exclusive jurisdiction of the courts of Newcastle upon Tyne, which means that you may make a claim to defend your consumer protection rights in regards to these Legal Terms in England, or in the EU country in which you reside.</p>
<ol>
<li><strong>DISPUTE RESOLUTION</strong></li>
</ol>
<p><strong>Binding Arbitration</strong></p>
<p>Any dispute arising from the relationships between the Parties to these Legal Terms shall be determined by one arbitrator who will be chosen in accordance with the Arbitration and Internal Rules of the European Court of Arbitration being part of the European Centre of Arbitration having its seat in Strasbourg, and which are in force at the time the application for arbitration is filed, and of which adoption of this clause constitutes acceptance. The seat of arbitration shall be Newcastle-upon-Tyne, England. The language of the proceedings shall be English. Applicable rules of substantive law shall be the law of England.</p>
...
<p><strong>Alien Jungle Ltd</strong></p>
<p><strong>PO Box C/O NATA</strong></p>
<p><strong>ARCH WORKSPACE LINTONVILLE PARKWAY</strong></p>
<p><strong>ASHINGTON, NORTHUMBERLAND NE63 9JZ</strong></p>
<p><strong><strong><strong>England</strong></strong></strong></p>
<p><strong><strong>Phone: 07861683881</strong></strong></p>
<p><strong><strong>aaron@yarbz.digital</strong></strong></p>`,
        }}
      ></div>
    </motion.main>
  );
