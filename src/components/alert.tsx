...
export default function Alert({ children, className, type }: AlertProps) {
  ...
  const classNameComputed = classNames(
    "py-[12px] px-[20px] rounded-md text-yd-tut-black shadow-yd-default flex flex-row items-center gap-x-[10px]",
    className,
    {
        ...
        <div className={classNameComputed}>
          ...
          >
            ...
            <path
              ...
              className="fill-yd-stroke-black"
            />
          </svg>
