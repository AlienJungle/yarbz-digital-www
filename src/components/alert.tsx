...
export default function Alert({ children, className }: AlertProps) {
  return (
    <div className={classNames("py-[12px] px-[20px] rounded-md bg-yd-tut-green text-yd-tut-black shadow-yd-default flex flex-row items-center", className)}>
      <svg height="24" viewBox="0 0 48 48" width="48" xmlns="http://www.w3.org/2000/svg">
