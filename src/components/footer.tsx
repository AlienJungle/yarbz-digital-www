...
export default function Footer(): JSX.Element {
  ...
  return (
    <footer className="grid grid-cols-3 items-center justify-between px-[45px] py-[40px]">
      ...
      <div className="flex flex-row justify-end gap-x-5">
        <a href="https://www.linkedin.com/in/aaronjyarborough/" target="_blank" rel="nofollow noopener" tabIndex={0}>
