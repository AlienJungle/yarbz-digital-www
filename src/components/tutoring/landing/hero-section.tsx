  ...
  return (
    <div className="landing-section flex flex-col lg:flex-row lg:items-center justify-between">
      <div className="lg:max-w-[553px] flex-shrink-0 relative flex flex-col items-center text-center lg:items-start lg:text-left">
        <motion.h1 className="mb-[20px]" variants={introBurstIn} initial="hidden" animate="visible">
        ...
        <motion.div className="flex flex-col sm:flex-row gap-[17px] lg:gap-[21px] items-center">
          <motion.div variants={animateButtonVariants} initial="hidden" animate="visible" whileHover="hover" whileTap="tap">
            <Link href={statics.trialLessonBookingURL} target="_blank" className={classNames("btn-tut inline-block", THEME_CLASSNAME_GREEN)}>
              Book a free trial lesson
            </Link>
          </motion.div>

          <motion.div variants={animateButtonVariants} initial="hidden" animate="visible" whileHover="hover" whileTap="tap">
            <Link href="#pricing" className={classNames("btn-tut inline-block", THEME_CLASSNAME_BLACK)}>
              Purchase sessions
            </Link>
          </motion.div>
        </motion.div>
