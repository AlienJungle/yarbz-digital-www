...
export default function ServicesSection() {
  ...
  return (
    <div className="landing-section" id="services">
      ...
      <motion.div variants={reviewParentsVariants} viewport={{ once: true }} initial="hidden" whileInView="visible" className="mt-[52px] lg:mt-[90px] grid lg:grid-cols-3 gap-x-[77px] gap-y-[70px] lg:gap-y-[80px]">
        {cards.map((card) => (
          <motion.div key={card.title} className="rounded-[8px] bg-yd-tut-lightgreen p-[32px] relative shadow-yd-default" variants={introBurstIn}>
