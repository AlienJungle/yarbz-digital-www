  ...
  return (
    ...
    >
      <div className="bg-yd-tut-black rounded-[15px] p-[25px] lg:p-[42px] flex flex-col items-center justify-center overflow-hidden relative">
        ...
        <h2 className="text-2xl lg:text-3xl text-yd-tut-white text-center lg:text-left">
          Ready to get started?
        </h2>
        <p className="my-[20px] lg:my-[30px] text-yd-tut-white text-center lg:text-left">
          Book a free trial session and kick-start your learning journey!
        </p>
        <motion.a
          whileTap={tapVariant}
          ...
          className={classNames(
            "btn-tut lg:mb-[40px] inline-block mb-[15px]",
