...
export default function CTASection() {
  return (
    <motion.div className="landing-section" initial="hidden" whileInView={"visible"} variants={introBurstIn}>
      <div className="bg-yd-tut-black rounded-[15px] p-[25px] lg:p-[42px] flex flex-col items-center justify-center overflow-hidden relative">
        ...
        <a href={statics.trialLessonBookingURL} target="_blank" rel="nofollow noopener" className={classNames("btn-tut lg:mb-[40px] inline-block mb-[15px]", THEME_CLASSNAME_GREEN)}>
          Book a trial lesson
        </a>
      </div>
    </motion.div>
