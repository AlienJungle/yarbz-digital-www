...
export default function BookCallCTABlock(): JSX.Element {
  return (
    <div className="landing-section container relative">
      <div className="max-w-[1012px] p-[25px] lg:p-[54px] flex flex-col items-center justify-center mx-auto bg-yd-light-grey rounded-2xl relative overflow-hidden">
        <Image src={bgOrangeWave} alt="" className="absolute bottom-0 pointer-events-none min-w-[1104px]" />
        <h2 className="text-2xl font-semibold text-yd-dark-blue text-center">Ready to take it to the next level?</h2>
        <p className="mt-[29px] mb-[48px] max-w-[578px] text-center">Book a free call with me to get started. If you&apos;d rather, you can contact me by email at aaron AT alienjungle DOT digital.</p>
